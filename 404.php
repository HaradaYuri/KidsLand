...
<main>
    ...
    <div class="page-heading__container fadeUpTrigger">
      <div class="page-heading__text">
        <h2 class="page-heading__text-jp two-lines">
          お探しのページが<br class="sp">見あたりません。
        </h2>
        <p class="page-heading__text-en txts-en">page not found</p>
      </div>
  ...
  <section class="notfound fadeUpTrigger">
    ...
    <ul class="notfound__list">
      <li class="notfound__item">・URLが変更された</li>
      <li class="notfound__item">・ページが存在しない</li>
    </ul>
