        ...
        <div class="yprogram__cards cards__container cards__container--bgL fadeUpTrigger">
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp4.webp" alt="タイトルが入ります。">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp5.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp6.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp7.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp8.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp9.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp10.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp11.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp12.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp1.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp2.webp" alt="タイトルが入ります。">
              <div class="text__block">
          ...
          <article>
            <div class="cards-yprogram fadeUpTrigger">
              <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/./assets/images/yprogram/yp3.webp" alt="タイトルが入ります。">
              <div class="text__block">
